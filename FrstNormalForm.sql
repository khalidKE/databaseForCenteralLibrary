...
-- User Phones
CREATE TABLE Users_Phone_frst (
    User_ID INT,
    Phone VARCHAR(20),
    PRIMARY KEY (User_ID, Phone),
    FOREIGN KEY (User_ID) REFERENCES Users_frst(User_ID)
);

-- Books
CREATE TABLE Books_frst (
...
-- Borrowed Books
CREATE TABLE Borrow_Books_frst (
    User_ID INT,
    Book_ID INT,
    Start_Date DATE,
    End_Date DATE,
    ...
    FOREIGN KEY (User_ID) REFERENCES Users_frst(User_ID),
    FOREIGN KEY (Book_ID) REFERENCES Books_frst(Book_ID)
);

-- Reviews
CREATE TABLE Review_frst (
    User_ID INT,
    Book_ID INT,
    Comment TEXT,
    Review_Date DATE,
...
-- Staff
CREATE TABLE Staff_frst (
    Staff_ID INT PRIMARY KEY,
    Role VARCHAR(100),
    Email VARCHAR(100),
    RepoartDate DATE,
    Sup_Staff_ID INT,
    FOREIGN KEY (Sup_Staff_ID) REFERENCES Staff_frst(Staff_ID)
);

-- Staff Phones
CREATE TABLE Staff_Phone_frst (
    Staff_ID INT,
    Phone VARCHAR(20),
    PRIMARY KEY (Staff_ID, Phone),
    FOREIGN KEY (Staff_ID) REFERENCES Staff_frst(Staff_ID)
);

-- Activities
CREATE TABLE Activity_frst (
...
-- Branch Library
CREATE TABLE Branch_Library_frst (
...
-- Notifications
CREATE TABLE Notifications_frst (
    Date DATE PRIMARY KEY,
    Message TEXT
);

-- To insert Data To Every Table

-- Users
INSERT INTO Users_frst (User_ID, UserName, Password, Email, DOB) VALUES
...
-- User Phones
INSERT INTO Users_Phone_frst (User_ID, Phone) VALUES
(1, '01012345678'),
(2, '01234567890'),
(3, '01123456789'),
(4, '01791376250'),
...
-- Books
INSERT INTO Books_frst (Book_ID, Title, Publisher_Date, Publisher, Status, E_Book) VALUES
...
-- Borrowed Books
INSERT INTO Borrow_Books_frst (User_ID, Book_ID, Start_Date, End_Date, Fines) VALUES
...
-- Reviews
INSERT INTO Review_frst (User_ID, Book_ID, Comment, Review_Date, Rating) VALUES
...
-- Staff
INSERT INTO Staff_frst (Staff_ID, Role, Email, RepoartDate, Sup_Staff_ID) VALUES
...
-- Staff Phones
INSERT INTO Staff_Phone_frst (Staff_ID, Phone) VALUES
(1, '01234567891'),
(2, '0122223344'),
(3, '0111222333'),
(4, '01485507700'),
...
-- Activities
INSERT INTO Activity_frst (Activity_ID, Name, Description, Start_Date, End_Date) VALUES
...
-- Events
INSERT INTO Event_frst (Date_Event, Name, Type) VALUES
...
-- Magazines
INSERT INTO Magazine_frst (Magazine_ID, Magazine_Name, Attribute, Price, Duration) VALUES
...
-- Branch Library
INSERT INTO Branch_Library_frst (NameOfLibrary, Address, Phone, Email) VALUES
...
-- Notifications
INSERT INTO Notifications_frst (Date, Message) VALUES
...
select * 
 ...
 select * 
 from Users_Phone_frst;

 select * 
 from Books_frst;

 select * 
 from Borrow_Books_frst;
 ...
 select * 
 from Branch_Library_frst;

 select * 
 from Notifications_frst;
